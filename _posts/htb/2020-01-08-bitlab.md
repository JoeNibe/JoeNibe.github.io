...
![image1]({{ site.url }}{{ site.baseurl }}/assets/images/htbimg/bitlab1.gif =x400){: .align-center}
...
3. Change the `README.md` file slightly so that the `git pull` command will have some updates to download and after the update it will execute the hook.  
    ...
    ![image1]({{ site.url }}{{ site.baseurl }}/assets/images/htbimg/bitlab2.gif =100x100){: .align-center}
And we are root.