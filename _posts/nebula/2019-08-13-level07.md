...
the variable host is passed to the script which can be controlled by the user. We can add additional commands using ;


There is another file named thttpd.conf. Lets see whats in it
...
There are few parameters here
user=flag07
dir=/home/flag07
port=7007

okay lets check for listening ports
...
Command injection is succesful and the id belongs to flag07. So lets run getflag now
